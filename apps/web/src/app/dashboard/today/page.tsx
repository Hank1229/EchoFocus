      ...
      <main className="mx-auto w-full max-w-5xl flex-1 px-6 pb-16 pt-8">
        {loadError ? (
          ...
          <div className="space-y-10">
            ...
            {row.productive_by_hour && (
              <section>
                <h2 className="text-label text-content-secondary">{t.today.focusByHour}</h2>
                <div className="mt-3">
                  <DayWaveform hours={row.productive_by_hour} label={t.today.focusByHour} />
                </div>
              </section>
            )}
          ...
          <div className="max-w-md border-t border-line pt-10">
            <Inbox size={28} strokeWidth={1.5} className="text-content-tertiary" />
            <h2 className="mt-4 text-title text-content">
              {t.today.noSyncedData}
            </h2>
            <p className="mt-3 text-body text-content-secondary">{t.today.noSyncedDesc}</p>
          </div>
        )}
      </main>
    </>
